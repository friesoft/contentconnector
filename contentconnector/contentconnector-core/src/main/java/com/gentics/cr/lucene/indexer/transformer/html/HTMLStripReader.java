...
/**
 * 
 * Last changed: $Date: 2010-04-01 15:21:41 +0200 (Do, 01 Apr 2010) $
	...
	***/
	...
	private int readTag() throws IOException {
		...
		if (name.equalsIgnoreCase("script") || name.equalsIgnoreCase("style")) {
			...
			/*
			 * From HTML4: Although the STYLE and SCRIPT elements use CDATA for their data model, for these elements,
			 * CDATA must be handled differently by user agents. Markup and entities must be treated as raw text and
			 * passed to the application as is. The first occurrence of the character sequence "</" (end-tag open
			 * delimiter) is treated as terminating the end of the element's content. In valid documents, this would be
			 * the end tag for the element.
			 */
