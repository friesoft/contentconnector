...
public class CRLuceneDeleteJob extends AbstractUpdateCheckerJob {
	 ...
	 */
	private static final Logger LOG = Logger.getLogger(CRLuceneDeleteJob.class);
	 ...
	 */
	public CRLuceneDeleteJob(final CRConfig config, final IndexLocation indexLoc, final ConcurrentHashMap<String, CRConfigUtil> configmap) {
